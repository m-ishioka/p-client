    ...
    <Container>
      <div className="flex flex-col justify-center items-start w-full max-w-3xl border-gray-200 dark:border-gray-700 mx-auto pb-16">
        ...
        <div className="mb-8 prose dark:prose-dark leading-6 w-full max-w-max">
          ...
          <h2>職務要約</h2>
          <p>
            高校卒業後、道路工事の現場監督、個人事業主（カメラマン）経験したのち、システム開発会社においてエンジニアとして、システム開発に従事してきました。
            システム開発においては、自社サービスの最初期の立ち上げに参画し、年間売り上げ3億円規模のサービスにグロースさせることができました。
            また、受託開発においては月間2000万MAUのサービスの運用保守及び、開発に携わった経験があります。
            担当業務としては、エンジニアとして、要件定義・基本設計・詳細設計・実装・テスト・運用まで一通り経験をしております。
          </p>
          <h2>個人的な制作物</h2>
          <ul>
            <li>
          ...
          <h2>このサイトの技術スタック</h2>
          <p>Typescript・React・Nextjs・go・grpc-web・mysql・docker</p>
        </div>
        <span className="h-16" />
      </div>
    </Container>
